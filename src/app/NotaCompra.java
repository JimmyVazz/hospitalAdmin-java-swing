   ...
   Connection con = null;
       ...
       Connection con = null;
        ...
        try {
          con = databaseControl.DatabaseHandler.getConnection();
           //modificar
            ps = con.prepareStatement("insert into NotaCompra (clave, Nombre, ApPat, ApMat, Fecha_Nac, Calle, Noext, Noint, Colonia, Municipio, Estado, RFC, CURP, Genero, Cedula_profesional, Telefono, Email) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ps.setString(1, txtClave.getText());
            ps.setString(2, txtIdCompra.getText());
            ...
            if (res > 0) {
                JOptionPane.showMessageDialog(null, "Nota Compra se registro con éxito!");
                limpiarCaja();
            }else{
    ...
    public void eliminarDatos(){
        ...
        try {
            con = databaseControl.DatabaseHandler.getConnection();
            //mod
            ps = con.prepareStatement("delete from NotaCompra where clave = ?");
            ps.setString(1, txtClave.getText());
            int res = ps.executeUpdate();
            if (res > 0) {
              JOptionPane.showMessageDialog(null, "Se elimino Nota con clave: "+txtClave.getText() + " de forma exitosa!"); 
              limpiarCaja();
            }else{
    ...
    public void buscarDatos(){
        ...
        try {
            ...
            ps = con.prepareStatement("select * from NotaCompra where clave = ?");
            ps.setString(1, txtClave.getText());
           
           rs = ps.executeQuery();
          
            if (rs.next() ) {
              txtIdCompra.setText(rs.getString("IdCompra"));
              txtIdProducto.setText(rs.getString("IDProducto"));
              txtCantidad.setText(Integer.toString(rs.getInt("ApMat")));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtIdCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 375, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
