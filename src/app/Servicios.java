   ...
   Connection con = null;
    ...
    private void guardarDatos() throws SQLException{
       ...
       Connection con = null;
        ...
        try {
           ...
           //mod
            ps = con.prepareStatement("insert into servicios (clave, Nombre, ApPat, ApMat, Fecha_Nac, Calle, Noext, Noint, Colonia, Municipio, Estado, RFC, CURP, Genero, Cedula_profesional, Telefono, Email) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ps.setString(1, txtClave.getText());
            ps.setString(2, txtNombre.getText());
            ps.setString(3, txtCategoria.getText());
            ps.setString(4, txtDescrp.getText());
            ps.setFloat(5, Float.parseFloat(txtCosto.getText()));
          
            
            int res = ps.executeUpdate();
            
            if (res > 0) {
                JOptionPane.showMessageDialog(null, "El servicio se registro con éxito!");
                limpiarCaja();
            }else{
    ...
    public void eliminarDatos(){
        ...
        try {
             con = databaseControl.DatabaseHandler.getConnection();
            //mod
            ps = con.prepareStatement("delete from servicios where clave = ?");
            ps.setString(1, txtClave.getText());
            int res = ps.executeUpdate();
            if (res > 0) {
              JOptionPane.showMessageDialog(null, "Se elimino el servicio con clave: "+txtClave.getText() + " de forma exitosa!"); 
              limpiarCaja();
            }else{
    ...
    public void buscarDatos(){
        ...
        try {
             con = databaseControl.DatabaseHandler.getConnection();
            //mod
            ps = con.prepareStatement("select * from servicios where clave = ?");
            ps.setString(1, txtClave.getText());
