   ...
   Connection con = null;
       ...
       Connection con = null;
        ...
        try {
          con = databaseControl.DatabaseHandler.getConnection();
           //modificar
            ps = con.prepareStatement("insert into especialidades (clave, Nombre, ApPat, ApMat, Fecha_Nac, Calle, Noext, Noint, Colonia, Municipio, Estado, RFC, CURP, Genero, Cedula_profesional, Telefono, Email) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ps.setString(1, txtClave.getText());
            ps.setString(2, txtNombre.getText());
            ps.setString(3, txtDescrp.getText());
            ps.setString(4, txtIdHospital.getText());
           
            
            int res = ps.executeUpdate();
            
            if (res > 0) {
                JOptionPane.showMessageDialog(null, "Especialidad se registro con éxito!");
                limpiarCaja();
            }else{
    ...
    public void eliminarDatos(){
        ...
        try {
            con = databaseControl.DatabaseHandler.getConnection();
            //modificar
            ps = con.prepareStatement("delete from despecialidades where clave = ?");
            ps.setString(1, txtClave.getText());
            int res = ps.executeUpdate();
            if (res > 0) {
              JOptionPane.showMessageDialog(null, "Se elimino Especialidad con clave: "+txtClave.getText() + " de forma exitosa!"); 
              limpiarCaja();
            }else{
    ...
    public void buscarDatos(){
        ...
        try {
            con = databaseControl.DatabaseHandler.getConnection();
            //modificar
            ps = con.prepareStatement("select * from especialidades where clave = ?");
            ps.setString(1, txtClave.getText());
           ...
           rs = ps.executeQuery();
            ...
            if (rs.next() ) {
              ...
              txtDescrp.setText(rs.getString("Descrp"));
