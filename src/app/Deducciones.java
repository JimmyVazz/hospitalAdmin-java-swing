   ...
   Connection con = null;
    ...
    private void guardarDatos() throws SQLException{
       ...
       Connection con = null;
        ...
        try {
            ...
            ps = con.prepareStatement("insert into Deducciones (clave, Nombre, ApPat, ApMat, Fecha_Nac, Calle, Noext, Noint, Colonia, Municipio, Estado, RFC, CURP, Genero, Cedula_profesional, Telefono, Email) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            if (res > 0) {
                JOptionPane.showMessageDialog(null, "Deduccion se registro con éxito!");
                limpiarCaja();
            }else{
    ...
    public void eliminarDatos(){
        ...
        try {
            ...
            int res = ps.executeUpdate();
            if (res > 0) {
              JOptionPane.showMessageDialog(null, "Se elimino deduccion con clave: "+txtClave.getText() + " de forma exitosa!"); 
              limpiarCaja();
            }else{
