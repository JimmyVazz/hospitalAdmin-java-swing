    ...
    private void guardarDatos() throws SQLException{
       ...
       Connection con = null;
        ...
        try {
           ...
           //mod
            ps = con.prepareStatement("insert into proveedores (clave, Nombre, ApPat, ApMat, Fecha_Nac, Calle, Noext, Noint, Colonia, Municipio, Estado, RFC, CURP, Genero, Cedula_profesional, Telefono, Email) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
